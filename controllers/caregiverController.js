...
exports.caregiver_get_by_id = function(req, res) {
    ...
    CareGiver.findAll({ where: {national_id: req.params.national_id} }).then(result => {
...
exports.caregiver_update_put = function(req, res) {
    ...
    CareGiver.update(
        req.body,
        {returning: true, where: {national_id: req.params.national_id} }
      )
...
exports.caregiver_delete = function(req, res) {
    ...
    .then(result => res.status(200).send(`Caregiver with id ${req.params.national_id} deleted.`))
